...
/**
 * Clase SectorBosqueEstadioUdnog
 */
class SectorBosqueEstadioUdnog extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre          = 'Desagregación Sector Bosque Estadio UDNOG';
        $this->autor           = 'IMPLAN Torreón Staff';
        $this->fecha           = '2015-09-15T12:00';
        // El nombre del archivo a crear (obligatorio) y rutas relativas a las imágenes
        $this->archivo         = 'sector-bosque-estadio-udnog';
    //  $this->imagen          = '';
    //  $this->imagen_previa   = '';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion     = 'Desagregación de Sector Bosque Estadio UDNOG en Torreón.';
...
<table class="table table-hover table-bordered listado-tabla">
  ...
  <tbody>
    <tr>
      <td>Hogares</td>
      <td class="entero">724</td>
    </tr>
    <tr>
      <td>Hogares Jefatura masculina</td>
      <td class="porcentaje">59.05 %</td>
    </tr>
    <tr>
      <td>Hogares Jefatura femenina</td>
      <td class="porcentaje">40.95 %</td>
    </tr>
    <tr>
      <td>Ocupación por Vivienda</td>
      <td class="flotante">3.3200</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="porcentaje">98.34 %</td>
    </tr>
    <tr>
      <td>Viviendas con Drenaje</td>
      <td class="porcentaje">98.48 %</td>
    </tr>
    <tr>
      <td>Viviendas con Televisión</td>
      <td class="porcentaje">95.99 %</td>
    </tr>
    <tr>
      <td>Viviendas con Automóvil</td>
      <td class="porcentaje">58.29 %</td>
    </tr>
    <tr>
      <td>Viviendas con Computadora</td>
      <td class="porcentaje">49.45 %</td>
    </tr>
    <tr>
      <td>Viviendas con Celular</td>
      <td class="porcentaje">69.48 %</td>
    </tr>
    <tr>
      <td>Viviendas con Internet</td>
      <td class="porcentaje">42.40 %</td>
    </tr>
  </tbody>
</table>
</div>
...
<table class="table table-hover table-bordered listado-tabla">
  ...
  <tbody>
    <tr>
      ...
      <td class="entero">600</td>
    </tr>
    <tr>
      <td>Primer actividad</td>
      <td class="texto">Comercio Menudeo 26.00 %</td>
    </tr>
    <tr>
      <td>Segunda actividad</td>
      <td class="texto">Otros servicios, excepto Gobierno 16.67 %</td>
    </tr>
    <tr>
      <td>Tercera actividad</td>
      <td class="texto">Preparación de Alimentos y Bebidas 12.67 %</td>
    </tr>
    <tr>
      <td>Cuarta actividad</td>
      <td class="texto">Salud 10.33 %</td>
    </tr>
    <tr>
      <td>Quinta actividad</td>
      <td class="texto">Industria Manufacturera 8.33 %</td>
    </tr>
  </tbody>
</table>
</div>
