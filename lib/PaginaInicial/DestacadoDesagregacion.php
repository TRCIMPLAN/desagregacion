<?php
/**
 * TrcIMPLAN Central - Página Inicial Destacado Desagregación
 *
...
class DestacadoDesagregacion extends SchemaProduct {
    ...
    public function __construct() {
        $this->name        = 'Proyecto Desagregación';
        $this->description = 'Un gran proyecto.';
        $this->image       = 'servicio-smi';
        $this->url         = 'desagregacion/introduccion.html';
    } // constructor
